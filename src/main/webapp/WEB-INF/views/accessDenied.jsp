...
<h2 class="form-signin-heading">Sorry, you do not have permission to view this page.</h2>

<span style="color: #cc0000; cursor: pointer">
Click <a href="${contextPath}/listProducts">here</a> to go back to the Homepage.
</span>
</body>
</html>